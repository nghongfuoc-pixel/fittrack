  ...
  head: () => ({
    meta: [
      ...
      ...seo({
        ...
        description: 'Ứng dụng theo dõi tập luyện thể hình, ghi buổi tập và theo dõi tiến bộ.',
      }),
    ],
    links: [
...
function AppShell({ children }: { children: React.ReactNode }) {
  ...
  const hideBottomNav = pathname.startsWith('/workout') || pathname.startsWith('/log/')
